...
===== `ssl_supported_protocols`
  ...
  * Value type is <<string,string>>
  * Supported values are: `TLSv1.1`, `TLSv1.2`, `TLSv1.3`
  * Default value depends on JDK defaults
